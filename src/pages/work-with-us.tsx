...
export default function WorkWithUs() {
  ...
  const handleInvestmentSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    alert(`Processing payment for ${plots} plots and ${acres} acres...`);
  };
      ...
      <section className="bg-green-900 text-white py-24 px-6 md:px-12 text-center relative">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl opacity-90 mb-10">
            ...
            create{" "}
            <span className="underline decoration-yellow-400">real impact</span>{" "}driving{" "}
      ...
      <section className="bg-gray-50 py-20 px-6 md:px-16">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          {[green7, green8, green9, green10].map((img, i) => {
            ...
            const icons = [<ShieldCheck />, <Users />, <BarChart3 />, <Globe />];
            const descriptions = [
